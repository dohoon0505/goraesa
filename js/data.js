...
const SECTIONS = {
  ...
  tab3: [
    ...
    { kicker: "", title: "새로운 출발을 축하하는 인기 화분", tag: "팀장·부장", items: [{ productId: "tab3-s1-2", id: "tab3-s1-2", name: "잎새가 아름다운 철골소심", price: 65000, img: "img/tab3_item2_img1.png" }, { productId: "tab3-s3-1", id: "tab3-s3-1", name: "넓은 잎이 특징인 산천보세", price: 65000, img: "img/tab3_item5_img1.png" }] },
    { kicker: "", title: "격식과 품위를 담은 프리미엄", tag: "임원·이사", items: [{ productId: "tab3-s1-1", id: "tab3-s1-1", name: "고급스러운 청자 황룡금", price: 85000, img: "img/tab3_item1_img1.png" }, { productId: "tab3-s2-2", id: "tab3-s2-2", name: "따듯한 인상의 연핑크 호접란", price: 120000, img: "img/tab3_item4_img1.png" }] }
  ],
  tab4: [
